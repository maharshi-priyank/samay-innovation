...
export default function Testimonials() {
  ...
  return (
    <section className="relative py-24 md:py-36 bg-[#fafaf8] overflow-hidden">
      ...
      <div className="container-custom relative z-10 max-w-4xl mx-auto px-6 md:px-8">
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-3 mb-16 md:mb-20"
        >
          <div className="h-px w-8 bg-accent-primary/50" />
          <span className="text-[10px] font-light tracking-[0.45em] uppercase text-accent-primary">
            Client Reviews
          </span>
          <div className="h-px w-8 bg-accent-primary/50" />
        </motion.div>
